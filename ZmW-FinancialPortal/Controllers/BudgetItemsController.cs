...
namespace ZmW_FinancialPortal.Controllers
{
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BudgetId,Name,CurrentBalance")] BudgetItem budgetItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BudgetId,Name,CurrentBalance")] BudgetItem budgetItem)
        {
            if (ModelState.IsValid)
            {
